const places = [{
  label: 'Bali',
  latitude: -8.3304977,
  longitude: 115.0906401,
  alternatives: ['Corse', 'Côte d\'Azur'],
}, {
  ...
  label: 'Grand Canyon',
  latitude: 36.0965604,
  longitude: -112.0984941,
  alternatives: ['Ocres de Rustrel'],
}, {
  label: 'Mont Everest',
  latitude: 27.9878675,
  longitude: 86.9248308,
  alternatives: ['Mont Blanc'],
}, {
  label: 'Sahara',
  latitude: 24.49215,
  longitude: -12.65625,
  alternatives: ['Dune du Pilat'],
}, {
  label: 'Darjeeling',
  latitude: 26.8349002,
  longitude: 88.3071496,
  alternatives: ['Rocamadour'],
}, {
  label: 'Autriche',
  latitude: 47.2000338,
  longitude: 13.199959,
  alternatives: ['Lac d\'Annecy', 'Chateau de Chantilly'],
}, {
  label: 'Rome',
  latitude: 41.89193,
  longitude: 12.51133,
